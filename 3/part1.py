...
def find_min_distance(wires):
    ...
    # print("{} => {}".format(vector['wires'][0], a))
    # print("{} => {}".format(vector['wires'][1], b))
    aa = set(a)
    bb = set(b)
    coords = list(aa.intersection(bb))
    # print(coords)
...
for vector in test_vectors:
    want = vector['answer']
    got = find_min_distance(vector['wires'])
    assert want == got
    # # print(coords)
    # print(f"Want: {vector['answer']}")
    # print("Got:  {}".format(ans))
    # sys.exit()

answer = find_min_distance(data['wires'])
